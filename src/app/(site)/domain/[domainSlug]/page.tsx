...
export async function generateMetadata({
  ...
  let title = `${domainName} Jobs (${total.toLocaleString()} Open ${roleWord}) | WorkWay`;
  let description = `Browse ${total.toLocaleString()} open ${domainName.toLowerCase()} ${jobWord} across top companies. Find the latest roles, apply directly, and explore opportunities on WorkWay.`;
